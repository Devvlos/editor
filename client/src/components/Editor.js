    ...
    <div class="flex flex-col h-screen">
      <div class="flex-1 grid grid-cols-2">
        <div id="bg" class="d border-r border-muted p-6 flex flex-col gap-4">
          ...
          <textarea
            id="realtimeEditorr"
            class="flex min-h-[80px] w-full bg-background text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 flex-1 resize-none border border-muted rounded-md p-4 focus:outline-none focus:ring-1 focus:ring-primary"
          ></textarea>
        </div>
        <div id="bg" class="bg-background p-6 flex flex-col gap-4">
          ...
          <div id="bgg" class="bg-muted rounded-md flex-1 overflow-auto">
            <div id="result"></div>
          </div>
